...
class PostHighlight(Command):
    ...
    def execute(self) -> None:
        ...
        Execute the command.
        """
        # Mark command as actively processing so parser won't enqueue duplicate retries.
        self.highlight.post_id = {"_pending": None}
        ...
        result = output.post_with_media(text, self.highlight.video)
